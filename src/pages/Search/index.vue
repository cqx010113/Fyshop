            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-arrowdown':isDesc,'icon-direction-up':isAsc}"></span></a>
                </li>
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-arrowdown':isDesc,'icon-direction-up':isAsc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      removeCategoryName(){
        //带给服务器的参数都是可有可无的,用undefined不会带给服务器
